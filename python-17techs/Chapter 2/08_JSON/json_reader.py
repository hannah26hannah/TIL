...
def open_json_file(filename):
    with open(filename, encoding='UTF8') as file:
        try:
            ...
            print('JSON 데이터를 파싱하는 데 실패했습니다. 사유={0}'.format(2))
            return None


json_data = open_json_file('python-17techs/Chapter 2/08_JSON/test.json')
if not json_data:
    # 더 이상 로직을 진행할 수 없으니 종료한다.
    exit(0)
...
# float_value가 3이상 3.2 미만인지 검사하는 코드
